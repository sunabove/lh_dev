				...
				<c:forEach var = "row" items = "${result.rows}"> 
					...
					<form action="" class="needs-validation" onsubmit="return check_submit();" >
						<div class="form-group">
							<label>아이디 : </label>
							<input type="text" class="form-control" value="${ row.mgr_id }" style="width:60%;" readonly >
						</div>
						<div class="form-group">
							<label>등급 : </label>
							<input type="text" class="form-control" id="user_grade" value="${ row.mgr_grade }" style="width:60%;" >
							<span id="user_grade_valid" class="help-block invisible text-danger">
								잘못된 등급입니다. 
							</span>
						</div>
						<div class="form-group">
							<label>이름 : </label>
							<input type="text" class="form-control" id="user_name" value="${ row.mgr_name }" style="width:60%;" >
							<span id="user_name_valid" id="user_name" class="help-block invisible text-danger">
								잘못된 이름입니다. 
							</span>
						</div>
						<div class="form-group">
							<label >비밀번호 : </label>
							<input type="password" class="form-control" id="user_pass" name="user_pass" style="width:60%;" >
						...
						<div class="form-group">
							<label >비밀번호 확인 : </label>
							<input type="password" class="form-control" id="user_pass2" style="width:60%;" >
							<span id="user_pass2_valid" class="help-block invisible text-danger">
								비밀번호가 일치하지 않습니다. 
							</span>
						</div>
